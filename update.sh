...
DEMO_NAME="ARIES Vision Transformer Demo"
DEMO_DIR_NAME="aries-vision-transformer-demo"
...
if [ -f /usr/share/applications/vision-transformer-demo.desktop ]; then
  sudo rm /usr/share/applications/vision-transformer-demo.desktop
fi
